		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.keshihao" placeholder="科室号" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
				...
				<el-button class="list-add-btn" v-if="btnAuth('zhenshixinxi','新增')" type="primary" @click="add('/index/zhenshixinxiAdd')">
...
<script>
	export default {
		...
		async created() {
			...
			this.selectOptionsList.push({name:'门诊类型',list:this.menzhenleixingOptions,tableName: 'menzhenleixing',check: -1})
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				if (this.formSearch.menzhenleixing != '') searchWhere.menzhenleixing = this.formSearch.menzhenleixing;
				...
				this.$http.get(`zhenshixinxi/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/zhenshixinxiDetail', query: params});
			},
