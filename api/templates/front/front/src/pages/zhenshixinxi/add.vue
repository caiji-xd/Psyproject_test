<template>
	<div class="add-update-preview">
		<el-form
			...
			label-width="180px"
			>
			<el-form-item class="add-item" label="诊室号" prop="zhenshihao">
				<el-input v-model="ruleForm.zhenshihao" 
					placeholder="诊室号" clearable :disabled=" false  ||ro.zhenshihao"></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item" label="科室号" prop="keshihao">
				<el-input v-model="ruleForm.keshihao" 
					placeholder="科室号" clearable :disabled=" false  ||ro.keshihao"></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item"  label="门诊类型" prop="menzhenleixing">
				<el-select v-model="ruleForm.menzhenleixing" placeholder="请选择门诊类型" :disabled=" false  ||ro.menzhenleixing" >
					<el-option
			...
			<el-form-item class="add-item"  label="挂号费" prop="guahaofei">
				<el-select v-model="ruleForm.guahaofei" placeholder="请选择挂号费" :disabled=" false  ||ro.guahaofei" >
					<el-option
			...
			<el-form-item class="add-item" label="医生介绍" prop="yishengjieshao">
				<editor 
...
<script>
	export default {
		...
		methods: {
			...
			// 多级联动参数
			info() {
				this.$http.get(`zhenshixinxi/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
					if (res.data.code == 0) {
			...
			async onSubmit() {
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`zhenshixinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								this.$message({
									message: '操作成功',
									type: 'success',
