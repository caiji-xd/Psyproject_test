<template>
	<div class="center-preview">
		...
		<div class="center-info">
			...
			<div class="img-box" v-if="userTableName=='xinliyisheng'">
				<img :src="sessionForm.zhaopian?baseUrl + sessionForm.zhaopian:require('@/assets/avator.png')">
			</div>
			<div class="info-item1" v-if="userTableName=='xuesheng'">
				<span class="icon iconfont "></span>
				<div class="label">学生学号：</div>
				<div class="text">{{sessionForm.xueshengxuehao}}</div>
			</div>
			...
			<div class="info-item5" v-if="userTableName=='xuesheng'">
				...
				<div class="text">{{sessionForm.xueshengshouji}}</div>
			</div>
		...
		<el-tabs class="center-tabs" tab-position="left" @tab-click="handleClick">
			<el-tab-pane label="个人中心">
				<el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="180px">
					<el-form-item class="center-item" v-if="userTableName=='xuesheng'" label="学生学号" prop="xueshengxuehao">
					...
					<el-form-item class="center-item" v-if="userTableName=='xuesheng'" label="学生手机" prop="xueshengshouji">
						<el-input v-model="sessionForm.xueshengshouji" placeholder="学生手机" ></el-input>
					</el-form-item>
...
<script>
	...
	export default {
		...
		created() {
			...
			if ('xuesheng' == this.userTableName) {
				this.$set(this.sessionForm, 'xueshengshouji', null);
			}
			if ('xuesheng' == this.userTableName) {
				this.$set(this.sessionForm, 'touxiang', null);
			}

			if ('xuesheng' == this.userTableName&&this.rules['xueshengxuehao']){
				this.rules['xueshengxuehao'].push({ required: true, message: '请输入学生学号', trigger: 'blur' })
			}else if('xuesheng' == this.userTableName&&!this.rules['xueshengxuehao']) {
			...
			if ('xuesheng' == this.userTableName) {
				this.$set(this.rules, 'xueshengshouji', [{ required: false, validator: this.$validate.isMobile, trigger: 'blur' }]);
			}
			if ('xuesheng' == this.userTableName&&this.rules['xueshengshouji']){
				this.rules['xueshengshouji'].push({ required: true, message: '请输入学生手机', trigger: 'blur' })
			}else if('xuesheng' == this.userTableName&&!this.rules['xueshengshouji']) {
				this.$set(this.rules, 'xueshengshouji', [{ required: true, message: '请输入学生手机', trigger: 'blur' }]);
			}
			if ('xuesheng' == this.userTableName&&this.rules['touxiang']){
				this.rules['touxiang'].push({ required: true, message: '请输入头像', trigger: 'blur' })
			}else if('xuesheng' == this.userTableName&&!this.rules['touxiang']) {
