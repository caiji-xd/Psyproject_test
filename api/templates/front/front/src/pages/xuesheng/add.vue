<template>
	<div class="add-update-preview">
		<el-form
			...
			label-width="180px"
			>
			<el-form-item class="add-item" label="学生学号" prop="xueshengxuehao">
			...
			<el-form-item class="add-item" label="学生手机" prop="xueshengshouji">
				<el-input v-model="ruleForm.xueshengshouji" 
					placeholder="学生手机" clearable :disabled=" false  ||ro.xueshengshouji"></el-input>
			</el-form-item>
		...
		data() {
			return {
				...
				rules: {
					...
					xueshengshouji: [
						{ required: true, message: '学生手机不能为空', trigger: 'blur' },
