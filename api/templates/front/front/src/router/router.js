...
import zhenshixinxiList from '../pages/zhenshixinxi/list'
import zhenshixinxiDetail from '../pages/zhenshixinxi/detail'
import zhenshixinxiAdd from '../pages/zhenshixinxi/add'
...
import discusszhenshixinxiList from '../pages/discusszhenshixinxi/list'
import discusszhenshixinxiDetail from '../pages/discusszhenshixinxi/detail'
import discusszhenshixinxiAdd from '../pages/discusszhenshixinxi/add'
      ...
      redirect: '/index/home'
    },
		{
			...
			children:[
				...
				{
					path: 'zhenshixinxi',
					component: zhenshixinxiList
				},
				{
					path: 'zhenshixinxiDetail',
					component: zhenshixinxiDetail
				},
				{
