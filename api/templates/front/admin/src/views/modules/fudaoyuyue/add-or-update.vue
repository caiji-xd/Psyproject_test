	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="教师工号" prop="yishenggonghao" >
					<el-input v-model="ruleForm.yishenggonghao" placeholder="教师工号" clearable  :readonly="ro.yishenggonghao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="教师工号" prop="yishenggonghao" >
