			...
			<el-form class="center-form-pv" :style='{"border":"0px solid #fff","margin":"0 0px 0px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","order":"2"}' >
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">学生学号</label>
					...
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">学生手机</label>
						<el-input v-model="searchForm.xueshengshouji" placeholder="学生手机" @keydown.enter.native="search()" clearable></el-input>
					</div>
		...
		methods: {
			...
			getDataList() {
				...
				if(this.searchForm.xingbie!='' && this.searchForm.xingbie!=undefined){
 				...
 				if(this.searchForm.xueshengshouji!='' && this.searchForm.xueshengshouji!=undefined){
					params['xueshengshouji'] = '%' + this.searchForm.xueshengshouji + '%'
				}
