...
# 获取会话信息接口
@main_bp.route("/python7n2a3/news/session", methods=['GET'])
def python7n2a3_news_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python7n2a3/news/page", methods=['GET'])
def python7n2a3_news_page():
    '''
    '''
    if request.method == 'GET':
...
# 分页接口（前端）
@main_bp.route("/python7n2a3/news/list", methods=['GET'])
def python7n2a3_news_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python7n2a3/news/save", methods=['POST'])
def python7n2a3_news_save():
    '''
    '''
...
# 添加接口（前端）
@main_bp.route("/python7n2a3/news/add", methods=['POST'])
def python7n2a3_news_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python7n2a3/news/thumbsup/<id_>", methods=['GET'])
def python7n2a3_news_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python7n2a3/news/info/<id_>", methods=['GET'])
def python7n2a3_news_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python7n2a3/news/detail/<id_>", methods=['GET'])
def python7n2a3_news_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python7n2a3/news/update", methods=['POST'])
def python7n2a3_news_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python7n2a3/news/delete", methods=['POST'])
def python7n2a3_news_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python7n2a3/news/vote/<int:id_>", methods=['POST'])
def python7n2a3_news_vote(id_):
    '''
    '''
    if request.method == 'POST':
...
# 批量审核
@main_bp.route("/python7n2a3/news/shBatch", methods=['POST'])
def python7n2a3_news_shBatch():
    '''
    '''
    ...
    if request.method == 'POST':
        ...
        try:
            for id in req_dict:
                data = news.getbyid(news, news, int(id))
                if len(data)>0:
                    data=data[0]
                    data['sfsh'] = sfsh
                    data['shhf'] = shhf
                    news.updatebyparams(news, news, data)
        except:
            pass
...
# 分组统计接口
@main_bp.route("/python7n2a3/news/group/<columnName>", methods=['GET'])
def python7n2a3_news_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
        ...
        msg['data'] = news.groupbycolumnname(news,news,columnName)
        return jsonify(msg)

# 按值统计接口
@main_bp.route("/python7n2a3/news/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python7n2a3_news_value(xColumnName, yColumnName):
...
# 按日期统计接口
@main_bp.route("/python7n2a3/news/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python7n2a3_news_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
        ...
        return jsonify(msg)
# 按值统计（多）
@main_bp.route("/python7n2a3/news/valueMul/<xColumnName>", methods=['GET'])
def python7n2a3_news_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/python7n2a3/news/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def python7n2a3_news_valueMul_time(xColumnName):
...
# 总数量
@main_bp.route("/python7n2a3/news/count", methods=['GET'])
def python7n2a3_news_count():
    '''
    '''
    if request.method == 'GET':
        ...
        msg['data']  = news.count(news, news, req_dict)
...
# 统计接口
@main_bp.route("/python7n2a3/news/remind/<columnName>/<type>", methods=['GET'])  #
def python7n2a3_news_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/python7n2a3/news/lists", methods=['GET'])
def python7n2a3_news_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
        ...
        return jsonify(msg)
# 排序接口
@main_bp.route("/python7n2a3/news/autoSort", methods=['GET'])
def python7n2a3_news_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 推荐算法接口
@main_bp.route("/python7n2a3/news/autoSort2", methods=['GET'])
def python7n2a3_news_autoSort2():
    if request.method == 'GET':
        ...
        L = []
        sql ="select * from news where  in ('%s"%("','").join(leixing)+"') union all select * from news where  not in('%s"%("','").join(leixing)+"')"
        data = db.session.execute(sql)
