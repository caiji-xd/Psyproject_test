...
# 获取会话信息接口
@main_bp.route("/python7n2a3/aboutus/session", methods=['GET'])
def python7n2a3_aboutus_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python7n2a3/aboutus/page", methods=['GET'])
def python7n2a3_aboutus_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python7n2a3/aboutus/autoSort", methods=['GET'])
def python7n2a3_aboutus_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 分页接口（前端）
@main_bp.route("/python7n2a3/aboutus/list", methods=['GET'])
def python7n2a3_aboutus_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python7n2a3/aboutus/save", methods=['POST'])
def python7n2a3_aboutus_save():
    '''
    '''
...
# 添加接口（前端）
@main_bp.route("/python7n2a3/aboutus/add", methods=['POST'])
def python7n2a3_aboutus_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python7n2a3/aboutus/thumbsup/<id_>", methods=['GET'])
def python7n2a3_aboutus_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python7n2a3/aboutus/info/<id_>", methods=['GET'])
def python7n2a3_aboutus_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python7n2a3/aboutus/detail/<id_>", methods=['GET'])
def python7n2a3_aboutus_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python7n2a3/aboutus/update", methods=['POST'])
def python7n2a3_aboutus_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python7n2a3/aboutus/delete", methods=['POST'])
def python7n2a3_aboutus_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 分组统计接口
@main_bp.route("/python7n2a3/aboutus/group/<columnName>", methods=['GET'])
def python7n2a3_aboutus_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
        ...
        msg['data'] = aboutus.groupbycolumnname(aboutus,aboutus,columnName)
        return jsonify(msg)

# 按值统计接口
@main_bp.route("/python7n2a3/aboutus/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python7n2a3_aboutus_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
    ...
    if request.method == 'GET':
        ...
        msg['data'] = aboutus.getvaluebyxycolumnname(aboutus,aboutus,xColumnName,yColumnName)
        return jsonify(msg)

# 按日期统计接口
@main_bp.route("/python7n2a3/aboutus/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python7n2a3_aboutus_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 推荐算法接口
@main_bp.route("/python7n2a3/aboutus/autoSort2", methods=['GET'])
def python7n2a3_aboutus_autoSort2():
    if request.method == 'GET':
