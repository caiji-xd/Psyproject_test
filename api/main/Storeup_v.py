...
# 获取会话信息接口
@main_bp.route("/python7n2a3/storeup/session", methods=['GET'])
def python7n2a3_storeup_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python7n2a3/storeup/page", methods=['GET'])
def python7n2a3_storeup_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python7n2a3/storeup/autoSort", methods=['GET'])
def python7n2a3_storeup_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 分页接口（前端）
@main_bp.route("/python7n2a3/storeup/list", methods=['GET'])
def python7n2a3_storeup_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python7n2a3/storeup/save", methods=['POST'])
def python7n2a3_storeup_save():
    '''
    '''
...
# 添加接口（前端）
@main_bp.route("/python7n2a3/storeup/add", methods=['POST'])
def python7n2a3_storeup_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python7n2a3/storeup/thumbsup/<id_>", methods=['GET'])
def python7n2a3_storeup_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python7n2a3/storeup/info/<id_>", methods=['GET'])
def python7n2a3_storeup_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python7n2a3/storeup/detail/<id_>", methods=['GET'])
def python7n2a3_storeup_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python7n2a3/storeup/update", methods=['POST'])
def python7n2a3_storeup_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python7n2a3/storeup/delete", methods=['POST'])
def python7n2a3_storeup_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python7n2a3/storeup/vote/<int:id_>", methods=['POST'])
def python7n2a3_storeup_vote(id_):
    '''
    '''
    if request.method == 'POST':
...
# 分组统计接口
@main_bp.route("/python7n2a3/storeup/group/<columnName>", methods=['GET'])
def python7n2a3_storeup_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/python7n2a3/storeup/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python7n2a3_storeup_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python7n2a3/storeup/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python7n2a3_storeup_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
