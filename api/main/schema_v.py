...
@main_bp.route("/python7n2a3/cal/<tableName>/<columnName>", methods=['GET'])
def python7n2a3_cal(tableName, columnName):
    '''
    计算规则接口
    '''
...
@main_bp.route("/python7n2a3/file/download", methods=['GET'])
def python7n2a3_file_download():
    '''
    '''
    if request.method == 'GET':
...
@main_bp.route("/python7n2a3/file/upload", methods=['POST'])
def python7n2a3_file_upload():
    '''
    '''
...
@main_bp.route("/python7n2a3/follow/<tableName>/<columnName>/<level>/<parent>", methods=['GET'])
def python7n2a3_follow_level(tableName, columnName, level,parent):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python7n2a3/follow/<tableName>/<columnName>", methods=['GET'])
def python7n2a3_follow(tableName, columnName):
    '''
...
@main_bp.route("/python7n2a3/location", methods=['GET'])
def python7n2a3_location():
    '''
...
@main_bp.route("/python7n2a3/matchFace", methods=['GET'])
def python7n2a3_matchface():
    '''
    baidubce百度人脸识别
    '''
    if request.method == 'GET':
...
@main_bp.route("/python7n2a3/option/<tableName>/<columnName>", methods=['GET'])
def python7n2a3_option(tableName, columnName):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python7n2a3/remind/<tableName>/<columnName>/<type>", methods=['GET'])  #
def python7n2a3_remind(tableName, columnName,type):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python7n2a3/sh/<tableName>", methods=['POST'])
def python7n2a3_sh(tableName):
    '''
    '''
    if request.method == 'POST':
        ...
        logging.warning("python7n2a3_sh.res=====>{}".format(res))
        return jsonify(msg)

@main_bp.route("/python7n2a3/upload/<fileName>", methods=['GET'])
def python7n2a3_upload(fileName):
    '''
    上传接口
    '''
    if request.method == 'GET':
...
@main_bp.route("/python7n2a3/group/<tableName>/<columnName>", methods=['GET'])
...
@main_bp.route("/python7n2a3/value/<tableName>/<xColumnName>/<yColumnName>", methods=['GET'])
